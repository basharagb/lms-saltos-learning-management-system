...
@section('page_title', 'إنشاء دفعة')
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">إنشاء دفعة</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
                ...
                <div class="col-md-6">
                    <form class="ajax-store" method="post" action="{{ route('payments.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input name="title" value="{{ old('title') }}" required type="text" class="form-control" placeholder="مثال: رسوم المدرسة">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <select class="form-control select" name="method" id="method">
                                    ...
                                    <option disabled value="Online">إلكتروني</option>
                                </select>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="amount" class="col-lg-3 col-form-label font-weight-semibold">المبلغ (<del style="text-decoration-style: double">N</del>) <span class="text-danger">*</span></label>
                            <div class="col-lg-9">
