...
@section('content')
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">إدارة الدرجات</h6>
            {!! Qs::getPanelOptions() !!}
        </div>

        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item"><a href="#all-grades" class="nav-link active" data-toggle="tab">إدارة الدرجات</a></li>
                <li class="nav-item"><a href="#new-grade" class="nav-link" data-toggle="tab"><i class="icon-plus2"></i> إضافة درجة</a></li>
            </ul>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="alert alert-info border-0 alert-dismissible">
                                ...
                                <span>إذا كانت الدرجة التي تقوم بإنشائها تنطبق على جميع أنواع الصفوف اختر <strong>غير قابل للتطبيق.</strong> وإلا اختر نوع الصف الذي تنطبق عليه الدرجة</span>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <form method="post" action="{{ route('grades.store') }}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input name="name" value="{{ old('name') }}" required type="text" class="form-control text-uppercase" placeholder="مثال: A1">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="class_type_id" class="col-lg-3 col-form-label font-weight-semibold">نوع الدرجة</label>
                                    <div class="col-lg-9">
                                        <select class="form-control select" name="class_type_id" id="class_type_id">
                                            <option value="">غير قابل للتطبيق</option>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label font-weight-semibold">الدرجة من <span class="text-danger">*</span></label>
                                    <div class="col-lg-3">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label font-weight-semibold">الدرجة إلى <span class="text-danger">*</span></label>
                                    <div class="col-lg-3">
                                ...
                                <div class="form-group row">
                                    <label for="remark" class="col-lg-3 col-form-label font-weight-semibold">الملاحظة</label>
                                    <div class="col-lg-9">
