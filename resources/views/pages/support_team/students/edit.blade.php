...
@section('page_title', 'تعديل الطالب')
@section('content')

        <div class="card">
            <div class="card-header bg-white header-elements-inline">
                <h6 id="ajax-title" class="card-title">يرجى ملء النموذج أدناه لتعديل سجل {{ $sr->user->name }}</h6>
            ...
            <form method="post" enctype="multipart/form-data" class="wizard-form steps-validation ajax-update" data-reload="#ajax-title" action="{{ route('students.update', Qs::hash($sr->id)) }}" data-fouc>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ $sr->user->name }}" required type="text" name="name" placeholder="الاسم الكامل" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ $sr->user->address }}" class="form-control" placeholder="العنوان" name="address" type="text" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input name="dob" value="{{ $sr->user->dob  }}" type="text" class="form-control date-pick" placeholder="اختر التاريخ...">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <span class="form-text text-muted">الصور المقبولة: jpeg, png. الحد الأقصى لحجم الملف 2 ميجابايت</span>
                            </div>
                        </div>
                    </div>
                ...
                <fieldset>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select onchange="getClassSections(this.value)" name="my_class_id" required id="my_class_id" class="form-control select-search" data-placeholder="اختر الصف">
                                    <option value=""></option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="section_id" required id="section_id" class="form-control select" data-placeholder="اختر الشعبة">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="my_parent_id">الوالد: </label>
                                <select data-placeholder="اختر..."  name="my_parent_id" id="my_parent_id" class="select-search form-control">
                                    <option  value=""></option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="year_admitted" data-placeholder="اختر..." id="year_admitted" class="select-search form-control">
                                    <option value=""></option>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="dorm_id">السكن الجامعي: </label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="dorm_room_no" placeholder="رقم غرفة السكن" class="form-control" value="{{ $sr->dorm_room_no }}">
                            </div>
                        </div>
                    </div>
                </fieldset>
