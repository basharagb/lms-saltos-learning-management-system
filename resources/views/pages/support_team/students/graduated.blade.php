...
@section('page_title', 'الطلاب المتخرجون')
@section('content')

<div class="card">
    <div class="card-header header-elements-inline">
        <h6 class="card-title">الطلاب المتخرجون</h6>
        {!! Qs::getPanelOptions() !!}
    </div>

    <div class="card-body">
        <ul class="nav nav-tabs nav-tabs-highlight">
            <li class="nav-item"><a href="#all-students" class="nav-link active" data-toggle="tab">جميع الطلاب المتخرجين</a></li>
