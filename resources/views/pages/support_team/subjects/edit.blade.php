...
@section('page_title', 'تعديل المادة - '.$s->name. ' ('.$s->my_class->name.')')
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">تعديل المادة - {{$s->my_class->name }}</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
                ...
                <div class="col-md-6">
                    <form class="ajax-update" method="post" action="{{ route('subjects.update', $s->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input name="name" value="{{ $s->name }}" required type="text" class="form-control" placeholder="اسم المادة">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input name="slug" value="{{ $s->slug }}"  type="text" class="form-control" placeholder="الاسم المختصر">
                            </div>
                        </div>
