            ...
            <div class="col-md-10">
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="subject_id" class="col-form-label font-weight-bold">المقرر:</label>
                                <select required id="subject_id" name="subject_id" data-placeholder="اختر البرنامج الأكاديمي أولاً" class="form-control select-search">
                                  @if($selected)
