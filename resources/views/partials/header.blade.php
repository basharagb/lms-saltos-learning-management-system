<div id="page-header" class="page-header page-header-light">
   ...
   {{--             <a href="#" class="btn btn-link btn-float text-default"><i class="icon-bars-alt text-primary"></i><span>Statistics</span></a>
                ...
                <a href="{{ Qs::userIsSuperAdmin() ? route('settings') : '' }}" class="btn btn-link btn-float text-default"><i class="icon-calendar3"></i> <span class="font-weight-semibold">الفصل الدراسي الحالي: {{ Qs::getSetting('current_session') }}</span></a>
            </div>
        </div>
    </div>
